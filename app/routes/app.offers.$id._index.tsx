    ...
    <s-page heading={offer.name}>
      <s-section>
        <s-stack direction="inline" gap="base" alignItems="center">
          ...
          <s-text color="subdued">{modeLabel(offer.mode)}</s-text>
      ...
      <s-section heading="Codes">
        {offer.codes.length === 0 ? (
          <s-text color="subdued">No active codes.</s-text>
        ) : (
      ...
      <s-section heading="Recent blocks">
        {recentFlagged.length === 0 ? (
          ...
          <s-stack gap="small">
            ...
            <s-button href={flaggedHref}>View all</s-button>
          </s-stack>
        )}
      </s-section>

      {totalFlagged > 0 ? (
        <s-section heading={`Flagged orders (${totalFlagged})`}>
          <s-stack gap="base">
            <s-text>
